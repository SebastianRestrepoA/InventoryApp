...
namespace InventoryApp {
    ...
    public partial class base1DataSet : global::System.Data.DataSet {
        ...
        public partial class productosDataTable : global::System.Data.TypedTableBase<productosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public productosRow AddproductosRow(int codigo, double valor, string producto, string descripcion) {
        ...
        public partial class productosRow : global::System.Data.DataRow {
            ...
            public double valor {
                get {
                    return ((double)(this[this.tableproductos.valorColumn]));
                }
                set {
                    this[this.tableproductos.valorColumn] = value;
                }
            }
...
namespace InventoryApp.base1DataSetTableAdapters {
    ...
    public partial class productosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[productos] WHERE (([codigo] = @Original_codigo) AND ([valor] =" +
                " @Original_valor) AND ([producto] = @Original_producto) AND ([descripcion] = @Or" +
                "iginal_descripcion))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[productos] ([codigo], [valor], [producto], [descripcion]) VALU" +
                "ES (@codigo, @valor, @producto, @descripcion);\r\nSELECT codigo, valor, producto, " +
                "descripcion FROM productos WHERE (codigo = @codigo)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[productos] SET [codigo] = @codigo, [valor] = @valor, [producto] = @producto, [descripcion] = @descripcion WHERE (([codigo] = @Original_codigo) AND ([valor] = @Original_valor) AND ([producto] = @Original_producto) AND ([descripcion] = @Original_descripcion));
SELECT codigo, valor, producto, descripcion FROM productos WHERE (codigo = @codigo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::InventoryApp.Properties.Settings.Default.base1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT codigo, valor, producto, descripcion FROM dbo.productos";
        ...
        public virtual int Delete(int Original_codigo, double Original_valor, string Original_producto, string Original_descripcion) {
        ...
        public virtual int Insert(int codigo, double valor, string producto, string descripcion) {
        ...
        public virtual int Update(int codigo, double valor, string producto, string descripcion, int Original_codigo, double Original_valor, string Original_producto, string Original_descripcion) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(double valor, string producto, string descripcion, int Original_codigo, double Original_valor, string Original_producto, string Original_descripcion) {
            return this.Update(Original_codigo, valor, producto, descripcion, Original_codigo, Original_valor, Original_producto, Original_descripcion);
        }
    }
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(base1DataSet.usuariosDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual base1DataSet.usuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            base1DataSet.usuariosDataTable dataTable = new base1DataSet.usuariosDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(base1DataSet.usuariosDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
